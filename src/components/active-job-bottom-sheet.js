...
export default function ActiveJobBottomSheet(props) {
  return (
    <View style={{ marginLeft: 18, marginTop: "5%" }}>
      ...
      <View style={{ flexDirection: "row" }}>
        ...
        <Image
          ...
          source={{ uri: props.job.job.image }}
        />
        {/* name ++ rating*/}
      ...
      <View style={{ marginTop: 10, marginLeft: 14, flexDirection: "row" }}>
        ...
        >
          ...
          >
            {parseInt(props.job.job.jobAmount).toLocaleString("en-US", {
              style: "decimal",
